 ...
 */
final class Version20200116134042 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, artisan_id INT DEFAULT NULL, customer_id INT DEFAULT NULL, name VARCHAR(100) NOT NULL, reference VARCHAR(50) NOT NULL, price INT NOT NULL, materials VARCHAR(50) NOT NULL, stock INT NOT NULL, description VARCHAR(300) NOT NULL, image VARCHAR(255) NOT NULL, INDEX IDX_D34A04AD5ED3C7B7 (artisan_id), INDEX IDX_D34A04AD9395C3F3 (customer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
